...
import { createStorageMock } from "../../test-helpers/storage";
import { LRUCache } from "../lib/cache";
import { I18nEngine } from "../lib/engine";
import type { I18nPlugin } from "../lib/plugins";
...
describe("I18nEngine v2.0", () => {
  ...
  beforeEach(() => {
    ...
    engine.registerTranslation("en", mockTranslations.en as unknown as import("../lib/types").TranslationMap);
    engine.registerTranslation("zh-CN", mockTranslations["zh-CN"] as unknown as import("../lib/types").TranslationMap);
  });
  ...
  describe("Error Handling", () => {
    ...
    it("should use custom missing key handler", () => {
      ...
      customEngine.registerTranslation("en", {} as unknown as import("../lib/types").TranslationMap);
